 ...
 * 클라이언트 섬: 마운트 시 서버 액션으로 목록을 불러오고, 본인 글은 삭제할 수 있다.
 * (작성은 각 장소 상세 페이지에서 — 현장성/맥락 유지)
 */
    ...
    return (
      <div className="mt-6 flex flex-col items-center gap-2 rounded-3xl border border-dashed border-neutral-200 py-16 text-center">
        <MessageSquareText
          ...
          strokeWidth={1.8}
        />
        <p className="text-sm text-neutral-400">아직 등록된 경험담이 없어요.</p>
        <p className="text-xs text-neutral-400">
          장소 상세 페이지에서 첫 이야기를 남겨보세요.
        </p>
      </div>
    );
  }
