...
const PLACES: Place[] = [
  ...
  },
  {
    ...
    description:
      "텐트·차박·캠핑카가 가능한 33개 사이트(일반야영 15·자동차야영 18)로, 전 사이트에서 마운틴뷰와 리버뷰를 함께 볼 수 있습니다. 도보 3분 거리의 1급수 홍천강에서 아이들과 다슬기 채집·물고기 낚시·물놀이를 즐길 수 있고, 다슬기 채집통·튜브 등 물놀이 용품도 대여합니다.",
    region: "강원특별자치도 홍천군 서면 개야로 357-18",
    mapQuery: "홍천 도담캠핑장",
  ...
  },
  {
    ...
    description:
      "모래·자갈 지면에 텐트를 300여 동까지 설치할 수 있는 선착순 이용 유원지로, '차박 성지'로도 불립니다. 수심이 깊지 않아 곳곳에서 견지·플라잉 낚시를 즐기는 사람들을 볼 수 있으며 피라미·쉬리·메기 등이 잡힙니다. 편의점·매점과 개수대·공용 화장실이 있고, 여름 성수기에는 입장료를 걷기도 하니 방문 전 확인하세요.",
  ...
  },
  {
    ...
    isolationScore: 3,
    category: "fishing",
    summary: "남면 시동리의 유료 관리형 붕어 낚시터(잡이터).",
    description:
      "남면 시동리에 자리한 유료 관리형 낚시터(잡이터)로 붕어 낚시 위주입니다. 어종·좌대·이용 요금은 시즌에 따라 달라질 수 있으니 방문 전 전화로 확인하세요.",
  ...
  },
  {
    ...
    description:
      "홍천강이 북한강과 만나기 전 서면 마곡리에 펼쳐 놓은 강변으로, 수심이 깊어 윈드서핑·수상스키 등 수상레저와 강변 낚시를 함께 즐깁니다. 화장실·개수대·매점 등 기본 편의시설이 있으나 다소 불편한 편이라 차박·캠핑 시 장비를 잘 챙기는 것이 좋습니다.",
    region: "강원특별자치도 홍천군 서면 마곡리",
    mapQuery: "홍천 마곡유원지",
