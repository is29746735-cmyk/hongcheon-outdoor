...
const PLACES: Place[] = [
  ...
  },
  {
    ...
    description:
      "모래·자갈 지면에 텐트를 300여 동까지 설치할 수 있는 선착순 이용 유원지로, '차박 성지'로도 불립니다. 수심이 깊지 않아 곳곳에서 견지·플라잉 낚시를 즐기는 사람들을 볼 수 있으며 피라미·쉬리·메기 등이 잡힙니다. 편의점·매점과 개수대·공용 화장실이 있고, 여름철에는 입장료(2,000원)를 받습니다.",
