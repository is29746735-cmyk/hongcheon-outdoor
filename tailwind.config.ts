...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // 중립·단일 레이어(컬러 틴트 제거)
        card: "0 1px 2px rgba(20,26,24,0.05), 0 6px 18px -10px rgba(20,26,24,0.14)",
        "card-hover":
          "0 2px 4px rgba(20,26,24,0.07), 0 12px 28px -12px rgba(20,26,24,0.22)",
      },
      keyframes: {
        "fade-up": {
